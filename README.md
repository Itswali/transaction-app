...
- [Live Demo Link](https://transaction-z840.onrender.com/)
...
```sh
  cd my-folder
  git clone https://github.com/Itswali/transaction-app.git
```
...
I would like to thank [gregoirevella](https://www.behance.net/gregoirevella) for the design
...
This project is [MIT](https://github.com/Itswali/transaction-app/blob/dev/MIT.md) licensed.

_NOTE: we recommend using the [MIT license](https://github.com/Itswali/transaction-app/blob/dev/MIT.md) - you can set it up quickly by [using templates available on GitHub](https://docs.github.com/en/communities/setting-up-your-project-for-healthy-contributions/adding-a-license-to-a-repository). You can also use [any other license](https://choosealicense.com/licenses/) if you wish._
